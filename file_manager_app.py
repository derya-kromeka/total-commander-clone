...
from PyQt5.QtWidgets import (
    ...
    QStyle, QTabWidget, QStackedWidget, QCheckBox, QComboBox, QSpinBox,
)
...
class SettingsDialog(QDialog):
    ...
    def __init__(self, settings_manager, parent=None):
        ...
        self._default_left_path = QLineEdit(self._settings.getSetting("default_left_path", ""), self)
        form.addRow("Default left path", self._default_left_path)

        self._default_right_path = QLineEdit(self._settings.getSetting("default_right_path", ""), self)
...
class FileManagerApp(QMainWindow):
    ...
    def _onToggleHidden(self, checked):
        ...
        self._showStatus("Hidden files " + ("shown" if checked else "hidden") + ".")
